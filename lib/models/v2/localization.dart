...
extension WeedLocalization on Weed {
  String localizedName(BuildContext context) {
    AppLocalizations.of(context)!.spoiled_food_name;
...
// extension FertilizerLocalization on Fertilizer {
//   static String localizedName(BuildContext context) {
//     AppLocalizations.of(context)!.spoiled_food_name;
...
//   static String localizedAssumedName(BuildContext context) {
//     // switch (this) {
//     //   case PotatoSeeds():
